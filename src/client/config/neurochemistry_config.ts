// ============================================================================
// NEUROCHEMISTRY CONFIGURATION — Circuit Hijack
// ============================================================================

import type { NeurochemistryConfig } from '../types/neurochemistry';

export const NEUROCHEMISTRY_CONFIG: NeurochemistryConfig = {
  INITIAL: {
    d1: 0.35,
    d2: 0.75,
    expectedReward: 0.4,
