...
export class SceneManager {
  ...
  private setupCharacter(): void {
    ...
    NeurochemistryManager.initialize(this.scene);
    ...
    if (this.characterController) {
      ...
      BehaviorManager.setNeuroHandlers({
        handleBehaviorAction: (action) => {
          NeurochemistryManager.handleBehaviorAction(action);
        },
        setNeuroZone: (zone, active) => {
          NeurochemistryManager.setNeuroZone(zone, active);
        }
      });
    }
