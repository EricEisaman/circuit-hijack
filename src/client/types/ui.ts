...
export interface HUDConfig {
  ...
  readonly METER_D1_COLOR: string;
  readonly METER_D2_COLOR: string;
  readonly METER_RPE_COLOR: string;
  readonly METER_HUNGER_COLOR: string;
  readonly METER_COUPLING_COLOR: string;
  readonly METER_HABIT_COLOR: string;
