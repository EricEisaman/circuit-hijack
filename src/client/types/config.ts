...
export interface CircuitHijackConfig {
  readonly ENABLED: boolean;
  readonly DEFAULT_CHARACTER: string;
  /** When set, settings environment dropdown shows only these names unless ?debug= is active. */
  readonly VISIBLE_ENVIRONMENTS: readonly string[] | null;
}
...
export interface GameConfig {
  ...
  readonly CIRCUIT_HIJACK: CircuitHijackConfig;
}
